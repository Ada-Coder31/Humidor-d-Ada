 ...
 * Aucune autre partie du code ne doit toucher IndexedDB directement :
 * tout passe par l'objet global DB ci-dessous. Ça isole "comment c'est
 * stocké" de "comment c'est utilisé", pour pouvoir changer de stockage
 * plus tard sans toucher au reste de l'app.
 *
 * Script classique (pas de module) : DB est exposé sur window.
 * ---------------------------------------------------------------------
 */
